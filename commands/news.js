...
module.exports = {
  ...
  async execute(sock, msg, args) {
    const param = args[0];
    if (!param && 'news' !== 'market' && 'news' !== 'gold' && 'news' !== 'news') {
      return sock.sendMessage(msg.key.remoteJid, { text: '❓ Usage: .news <parameter>' });
    }
    ...
    try {
      let apiUrl = `https://apis.xwolf.space/api/economy/news`;
      let paramLabel = '';
