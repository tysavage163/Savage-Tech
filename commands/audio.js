...
module.exports = {
    ...
    async execute(sock, msg, args) {
        ...
        if (!query) {
            return sock.sendMessage(from, { text: '🎵 Usage: .audio <song name or YouTube URL>' }, { quoted: msg });
        }
        ...
        try {
            ...
            const endpoint = `https://apis.xwolf.space/download/audio?url=${encodeURIComponent(videoUrl)}`;
