...
module.exports = {
  ...
  async execute(sock, msg, args) {
    ...
    try {
      await sock.sendMessage(msg.key.remoteJid, { text: '🎴 Fetching random bonk anime...', mentions: [jid] });
      ...
      await sock.sendMessage(msg.key.remoteJid, { text: '❌ Failed to fetch anime bonk.' });
    }
  }
};
