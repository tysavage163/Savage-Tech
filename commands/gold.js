...
module.exports = {
  ...
  async execute(sock, msg, args) {
    const param = args[0];
    if (!param && 'gold' !== 'market' && 'gold' !== 'gold' && 'gold' !== 'news') {
      return sock.sendMessage(msg.key.remoteJid, { text: '❓ Usage: .gold <parameter>' });
    }
    ...
    try {
      let apiUrl = `https://apis.xwolf.space/api/economy/gold`;
      let paramLabel = '';
