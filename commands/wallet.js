...
module.exports = {
  ...
  async execute(sock, msg, args) {
    const param = args[0];
    if (!param && 'wallet' !== 'market' && 'wallet' !== 'gold' && 'wallet' !== 'news') {
      return sock.sendMessage(msg.key.remoteJid, { text: '❓ Usage: .wallet <parameter>' });
    }
    ...
    try {
      ...
      if ('wallet' === 'forex') {
        ...
        // market, gold, news
        apiUrl = `https://apis.xwolf.space/api/economy/wallet`;
      }
      ...
      let output = `📊 *ECONOMIC DATA: wallet*`;
