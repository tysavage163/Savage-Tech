module.exports = {
    ...
    execute: async (sock, msg, args, { isMe }) => {
        ...
        if (!args[0]) return sock.sendMessage(from, { text: 'Usage: .gaterules on/off' }, { quoted: msg });
        ...
        await sock.sendMessage(from, { text: `✅ Rules acceptance requirement: ${state.toUpperCase()}` }, { quoted: msg });
    }
};
