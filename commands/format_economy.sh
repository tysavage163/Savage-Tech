...
module.exports = {
  ...
  async execute(sock, msg, args) {
    ...
    try {
      ...
      let output = `📊 *ECONOMIC DATA: CMD_NAME*`;
...
ENDJS
  ...
  echo "✅ Formatted ${cmd}.js"
done
echo "All economy commands reformatted nicely."
