...
module.exports = {
  ...
  async execute(sock, msg, args) {
    const param = args[0];
    if (!param && 'market' !== 'market' && 'market' !== 'gold' && 'market' !== 'news') {
      return sock.sendMessage(msg.key.remoteJid, { text: '❓ Usage: .market <parameter>' });
    }
    ...
    try {
      let apiUrl = `https://apis.xwolf.space/api/economy/market`;
      let paramLabel = '';
      ...
      let output = `📊 *ECONOMIC DATA: market*`;
