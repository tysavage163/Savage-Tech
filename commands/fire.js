...
module.exports = {
  name: 'fire',
  category: 'Ephoto',
  description: 'Generate fire text effect',
  async execute(sock, msg, args) {
    const text = args.join(' ');
    if (!text) return sock.sendMessage(msg.key.remoteJid, { text: '❓ Usage: .fire <text>' });
    ...
    try {
      const apiUrl = `https://apis.xwolf.space/api/textpro/fire?text=${encodeURIComponent(text)}`;
      ...
      const caption = `🎨 *Text Effect: fire*\n👤 REQUESTED BY: @${senderName}\n🚀 POWERED BY SAVAGE-CORE`;
